...
const {
  fluid: {
    info,
    buttons: {clickMe, hoverMe, selectMe}
  }
} = sections

export function Clickable() {
  const {scaleX, scaleY, opacity} = useTheatre(
    "Button",
    ["scaleX", "scaleY", "opacity"],
    TLClickable
  )
  const {textScale, shadowSize, shadowAlpha} = useTheatre(
    "Text",
    ["textScale", "shadowSize", "shadowAlpha"],
    TLClickable
  )
  const circle = useTheatre(
    "Circle",
...
export function Hoverable() {
  ...
  const circleOne = useTheatre(
    "CircleOne",
    ["marginLeft", "marginTop", "size", "opacity"],
    TLHoverable
  )
  const circleTwo = useTheatre(
    "CircleTwo",
    ["marginLeft", "marginTop", "size", "opacity"],
    TLHoverable
  )
  const circleThree = useTheatre(
    "CircleThree",
    ["marginLeft", "marginTop", "size", "opacity"],
    TLHoverable
  )
  const CircleFour = useTheatre(
    "CircleFour",
    ["marginLeft", "marginTop", "size", "opacity"],
    TLHoverable
  )
    ...
    >
      <div className={"button--circles-container" + (hover ? " show" : "")}>
        <div
          ...
          style={{...circleOne, width: circleOne.size, height: circleOne.size}}
        />
        <div
          className="button--circle"
          style={{...circleTwo, width: circleTwo.size, height: circleTwo.size}}
        />
        <div
          className="button--circle"
          style={{
            ...circleThree,
            width: circleThree.size,
            height: circleThree.size
          }}
        />
        <div
          className="button--circle"
          style={{
            ...CircleFour,
            width: CircleFour.size,
            height: CircleFour.size
          }}
        />
      </div>
    </Button>
